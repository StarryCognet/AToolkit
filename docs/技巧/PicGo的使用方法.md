...
1. **安装**
    - **Windows**：从官网下载 Windows 版本的安装包，然后按照提示进行安装
        ...
        * 然后按照提示进行安装。
    - 或者通过蓝奏云下载
        * 下载链接：<https://starryweb.lanzout.com/i2ymP2nvepub>  
          密码: `ehvi`
2. **打开**
    - 双击打开，注意如果**窗口**没有直接出现，要点开托盘再点 picgo 就行了
...
3. **配置**
    ...
    - **配置图床**：打开 PicGo 软件，在设置中选择“图床设置”，根据自己的需求选择合适的图床服务，如阿里云 OSS、腾讯云 COS、GitHub 等。可以参照本项目已有的配置：
![](https://cdn.nlark.com/yuque/0/2025/png/42939896/1739617698184-a24008af-5fe2-4efe-ba57-478fca9578da.png)
    - **配置：**
        ...
        * **设定SecretKey:** `3ua3MRN...obQ8f1A8vW`  
          ⚠️ **千万不要告诉别人不然可能会被 DDoS 攻击**
        * **设定Bucket:** starrywebpic-1324480062
        * **设定AppId:** 1324480062
        * **设定存储区域:** ap-guangzhou
        * **设定存储路径: **test/
        * **设定自定义域名:** 不填
...
![](https://cdn.nlark.com/yuque/0/2025/png/42939896/1739618113306-6bb32edc-738d-4d88-92b4-7357162722ca.png)
    ...
    - **复制链接：**在上传区域点击**URL**
![](https://cdn.nlark.com/yuque/0/2025/png/42939896/1739618171359-01fb9783-d718-4a9a-ac77-25bf7fc8b927.png)然后找到相册想要复制的图片后复制就可以了
